const commands = {
  ...
  GENERATIVE_IMAGE_BACKGROUND_DONE: "Generative the image background Process Done",
  GENERATIVE_PARTIAL_CONTENT: "Generate the partial content",
  GENERATIVE_PARTIAL_CONTENT_DONE: "Generative the partial content Process Done",
